    ...
    >
      ...
      >
        ...
        <div
          style={{
            ...
            fontWeight: '950',
            fontSize: '1.2rem',
            boxShadow: '0 4px 16px rgba(13, 78, 68, 0.18), inset 0 1px 0 rgba(255, 255, 255, 0.25)',
            flexShrink: 0,
            position: 'relative',
      ...
      >
        {navSections.map((section) => (
          <div key={section.title} style={{ marginBottom: '0' }}>
            <div
              style={{
        ...
        <Link href="/settings" style={{ textDecoration: 'none' }} onClick={onClose}>
          <div
            style={{
              ...
              transition: 'all 0.2s',
              cursor: 'pointer',
              background: hoveredItem === 'settings' ? 'rgba(255, 255, 255, 0.08)' : 'transparent',
              minHeight: '44px',
            }}
