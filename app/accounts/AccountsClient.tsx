...
export default function AccountsClient() {
  const { accounts, addAccount, updateAccount, deleteAccount, addFunds, addTransaction, loading } =
    useLedger();
    ...
    try {
      ...
      if (sourceAccount && targetAccount) {
        if (sourceAccount.id === targetAccount.id) {
          showNotification('error', 'Choose two different accounts for a transfer.');
          return;
        }

        await addTransaction({
          date: new Date().toISOString().split('T')[0],
          description: `${sourceAccount.name} to ${targetAccount.name}`,
          category: 'Transfer',
          type: 'Expense',
        ...
        showNotification('success', 'Transfer recorded in ledger and account balances updated');
      }
